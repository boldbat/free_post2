            ...
            <>
              <div className="">
                ...
                <BlurIn delay={1.4}>
                  <p
                    className={cn(
                      "md:self-start md:mt-2 font-thin text-sm text-slate-400 dark:text-zinc-500 ml-3",
                      "cursor-default font-display sm:text-lg md:text-lg whitespace-nowrap bg-clip-text "
                    )}
                  >
              ...
              <div className="mt-8 md:ml-2 flex flex-col gap-3">
                <Link
                  href={
                    "https://drive.google.com/file/d/1BOLDBAT_RESUME_ID/view?usp=sharing"
                  }
                  target="_blank"
                  className="flex-1"
                >
